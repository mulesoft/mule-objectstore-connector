...
import static org.test.extension.localobjectstore.AllureConstants.ObjectStoreFeature.OS_CONNECTOR;
import static org.test.extension.localobjectstore.AllureConstants.ObjectStoreFeature.ObjectStoreStory.IMPLICIT_STORE;
...
public class DefaultPartitionTestCase extends AbstractObjectStoreTestCase {
  ...
  private CoreEvent test(String flowName) throws Exception {
