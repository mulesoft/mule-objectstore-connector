...
import org.test.extension.localobjectstore.internal.error.AvailabilityErrorTypeProvider;
import org.test.extension.localobjectstore.internal.error.ContainsErrorTypeProvider;
import org.test.extension.localobjectstore.internal.error.RemoveErrorTypeProvider;
import org.test.extension.localobjectstore.internal.error.RetrieveErrorTypeProvider;
import org.test.extension.localobjectstore.internal.error.StoreErrorTypeProvider;
import org.test.extension.localobjectstore.internal.lock.LocalLockFactory;
...
import static org.test.extension.localobjectstore.internal.error.ObjectStoreErrors.KEY_NOT_FOUND;
...
/**
 * Operations for the LocalObjectStore connector
 *
 * @since 1.0
 */
public class LocalObjectStoreOperations {

  private static final LockFactory LOCK_FACTORY = new LocalLockFactory();
  ...
  private Lock getKeyLock(String key, ObjectStore<Serializable> objectStore) {
    ...
    return LOCK_FACTORY.createLock(getStoreLockKey(objectStore) + "_" + key);
  }
  ...
  private Lock getStoreLock(ObjectStore<Serializable> objectStore) {
    return LOCK_FACTORY.createLock(getStoreLockKey(objectStore));
  }
